  ...
  return (
    <div id='blogs' className='flex justify-center items-center'
      ...
      <div className=''>
        ...
        <button className='cursor-pointer mx-auto mt-4 flex items-center rounded-full bg-primary hover:bg-secondary transition-all text-white px-8 py-4 text-sm gap-2'>
